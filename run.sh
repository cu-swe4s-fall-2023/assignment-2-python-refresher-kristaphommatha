...
echo "Opening Agrofood_co2_emission.csv and searching column 1 for Afghanistan and outputting results from column 3"
python print_fires.py --file_name Agrofood_co2_emission.csv --qc 1 --qv 'Afghanistan'
